...
mfpca_est<-function(X){
  ...
  #Scalar convarinace function in the paper in Eq.A12
  ...
  npc <- 0 
  d0 <- 0
  while(npc<0.95){ #specify percentage of convaraince 
    d0 <- d0+1
  ...
  for(k in 1:d0){
    ...
    #normalize eigenfunction to be with norm of 1 in Eq.A14 of appendix B
  ...
  #5. mfpca scores 6.correaltion matrix between p sensors. 
